 ...
 */
public class OutPOStView extends FrameView
{
  ...
  public OutPOStView(SingleFrameApplication app)
  {
    super(app);
    ...
    modulesPane.addTab("Fuel info", starbaseStatusPanel);
    
    fuelPlannerPanel = new FuelPlannerPanel();
    modulesPane.addTab("Fuel planner", fuelPlannerPanel);
  ...
  public void showAboutBox()
  {
    if (aboutBox == null)
    {
      JFrame mainFrame = OutPOStApp.getApplication().getMainFrame();
      aboutBox = new OutPOStAboutBox(mainFrame);
      aboutBox.setLocationRelativeTo(mainFrame);
    }
    OutPOStApp.getApplication().show(aboutBox);
  }
  ...
  private void initComponents() {
    ...
    org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(evetycoon.OutPOStApp.class).getContext().getResourceMap(OutPOStView.class);
    ...
    javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(evetycoon.OutPOStApp.class).getContext().getActionMap(OutPOStView.class, this);
